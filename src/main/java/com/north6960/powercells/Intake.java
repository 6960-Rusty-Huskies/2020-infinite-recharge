...
public class Intake extends PIDSubsystem {
  ...
  public Intake() {
    ...
    wheelMotor = new VictorSPX(Constants.CAN.INTAKE_WHEEL_MOTOR);
    armMotor = new VictorSPX(Constants.CAN.INTAKE_ARM_MOTOR);
    armEncoder = new Encoder(Constants.Digital.INTAKE_ENCODER_A, Constants.Digital.INTAKE_ENCODER_B);
